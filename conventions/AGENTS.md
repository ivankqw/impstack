...
- Use `[observed: <date> <who>]` for a one-off observation that a document cannot reproduce. Measure the premise before a write pass. Confirm that its required records or accounts exist.
